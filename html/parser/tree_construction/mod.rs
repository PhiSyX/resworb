...
impl HTMLTreeConstruction {
    ...
    fn handle_initial_insertion_mode(
        &mut self,
        token: HTMLToken,
    ) -> HTMLTreeConstructionControlFlow {
        match token {
    ...
    fn handle_before_html_insertion_mode(
        &mut self,
        token: HTMLToken,
    ) -> HTMLTreeConstructionControlFlow {
        match token {
    ...
    fn handle_before_head_insertion_mode(
        &mut self,
        token: HTMLToken,
    ) -> HTMLTreeConstructionControlFlow {
        match token {
    ...
    fn handle_in_head_insertion_mode(
        &mut self,
        token: HTMLToken,
    ) -> HTMLTreeConstructionControlFlow {
        match token {
            ...
            | HTMLToken::Tag(
                ...
                return ControlFlow::Continue(HTMLParserState::SwitchTo(
    ...
    fn handle_after_head_insertion_mode(
        &mut self,
        token: HTMLToken,
    ) -> HTMLTreeConstructionControlFlow {
        match token {
    ...
    fn handle_in_body_insertion_mode(
        &mut self,
        mut token: HTMLToken,
    ) -> HTMLTreeConstructionControlFlow {
